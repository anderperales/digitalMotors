  ...
  return (
    <div className="p-4 bg-gray-100 rounded-lg">
      <div className="flex items-center justify-between gap-2">
        {!hideBadge && <Badge customColor="bg-blue-800" customText={title} customClassName="self-start" />}
                    ...
                    <td key={col.key as string} className={`border p-2 ${col.customCSS} ${columnsHiddens.includes(col.key as string) ? "hidden" : ""}`}>
                    {
                      ...
                      Array.isArray(item[col.key]) && item[col.key].length > 0 ? (
                        <button
                          ...
                          className="px-2 py-1 bg-blue-800 text-white rounded hover:bg-blue-900 flex items-center gap-1"
                        >
                          <HiDocument />
